...
\documentclass{LZUThesis-PgD&PhD}
\usepackage{appendix}
\usepackage{booktabs}
\usepackage{float}
\usepackage{amsmath}
...
\usepackage{braket}
\usepackage{tikz}
\usetikzlibrary{decorations.pathmorphing,decorations.markings,patterns,arrows.meta}
\usepackage{listings}
\usepackage{xcolor}
...
\newcommand{\Lcp}{\Lambda_c^+}
\newcommand{\LcptoXenu}{\Lambda_c^+ \to X e^+ \nu_e}
\newcommand{\chindf}{\chi^2/\mathrm{n.d.f.}}
\setCJKmainfont{Songti SC Light}[BoldFont={Songti SC Bold}]
\setCJKsansfont{Heiti SC Light}[BoldFont={Heiti SC Medium}]
\setCJKfamilyfont{zhsong}{Songti SC Light}[BoldFont={Songti SC Bold}]
\setCJKfamilyfont{zhhei}{Heiti SC Light}[BoldFont={Heiti SC Medium}]
\setCJKfamilyfont{zhfs}{Songti SC Light}[BoldFont={Songti SC Bold}]
\setCJKfamilyfont{zhkai}{KaiTi SC}[BoldFont={KaiTi SC Bold}]
\newcommand{\kaishuCJK}[1]{{\CJKfamily{zhkai}#1}}
\lstset{
...
\input{Theoretical_Study_on_Semi-leptonic_Decay.tex}
\input{Data_Analysis_Phenomenonology.tex}
\input{CKMV_csd.tex}
\input{Charm_Baryon_case.tex}
\input{mass_scheme.tex}
\input{system_engineering.tex}
\input{Summary.tex}
\begin{appendix}
